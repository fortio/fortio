...
var (
	...
	newMaxPayloadSizeKb = flag.Int("maxpayloadsizeKb", fhttp.MaxPayloadSize/1024, "MaxPayloadSize is the maximum size of payload to be generated by the EchoHandler size= argument. In Kbytes.")

...
```shell
curl -L https://github.com/fortio/fortio/releases/download/v1.65.1/fortio-linux_amd64-1.65.1.tgz \
 | sudo tar -C / -xvzpf -
# or the debian package
wget https://github.com/fortio/fortio/releases/download/v1.65.1/fortio_1.65.1_amd64.deb
dpkg -i fortio_1.65.1_amd64.deb
# or the rpm
rpm -i https://github.com/fortio/fortio/releases/download/v1.65.1/fortio-1.65.1-1.x86_64.rpm
...
On Windows, download https://github.com/fortio/fortio/releases/download/v1.65.1/fortio_win_1.65.1.zip and extract `fortio.exe` to any location, then using the Windows Command Prompt:
```
fortio.exe server
```

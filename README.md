...
```shell
curl -L https://github.com/fortio/fortio/releases/download/v1.18.2/fortio-linux_x64-1.18.2.tgz \
 | sudo tar -C / -xvzpf -
# or the debian package
wget https://github.com/fortio/fortio/releases/download/v1.18.2/fortio_1.18.2_amd64.deb
dpkg -i fortio_1.18.2-1_amd64.deb
# or the rpm
rpm -i https://github.com/fortio/fortio/releases/download/v1.18.2/fortio-1.18.2-1.x86_64.rpm
```
...
On Windows, download https://github.com/fortio/fortio/releases/download/v1.18.2/fortio_win_1.18.2.zip and extract `fortio.exe` to any location, then using the Windows Command Prompt:
```
fortio.exe server
```

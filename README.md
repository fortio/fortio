...
```shell
curl -L https://github.com/fortio/fortio/releases/download/v1.63.10/fortio-linux_amd64-1.63.10.tgz \
 | sudo tar -C / -xvzpf -
# or the debian package
wget https://github.com/fortio/fortio/releases/download/v1.63.10/fortio_1.63.10_amd64.deb
dpkg -i fortio_1.63.10_amd64.deb
# or the rpm
rpm -i https://github.com/fortio/fortio/releases/download/v1.63.10/fortio-1.63.10-1.x86_64.rpm
...
On Windows, download https://github.com/fortio/fortio/releases/download/v1.63.10/fortio_win_1.63.10.zip and extract `fortio.exe` to any location, then using the Windows Command Prompt:
```
fortio.exe server
```

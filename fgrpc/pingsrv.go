...
// the destination).
func PingClientCall(serverAddr string, cacert string, n int, payload string) (float64, error) {
...
// service.
func GrpcHealthCheck(serverAddr string, cacert, svcname string, n int) (*HealthResultMap, error) {

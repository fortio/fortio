...
func SharedMain(usage func(io.Writer, ...interface{})) {
	flag.Var(&headersFlags, "H", "Additional http header(s) or grpc metadata (for grpc, the key characters should be in [0-9a-z-_.] "+
		"and the host header will be converted to :authority pseudo-header). Multiple key:value pairs can be passed using multiple -H.")
